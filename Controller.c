...
int controller_editEmployee(LinkedList* pArrayListEmployee)
{
    ...
    {
        if(!getInt(&bufferId,"Ingrese un ID a modificar: ", "Error al ingresar ID. Reintente", 0, ll_len(pArrayListEmployee),2))
        {
...
int controller_ListEmployee(LinkedList* pArrayListEmployee)
{
    ...
    {
        pEmployee = ll_get(pArrayListEmployee, i);//guardar en un puntero a empleado
        if(pEmployee != NULL)
        {
