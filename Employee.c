...
{
    int retorno = -1;
    if(this != NULL && horasTrabajadas != NULL && !validarNumero(horasTrabajadas))//Validar que lo que recibe es un numero.
    {
...
{
    int retorno = -1;
    if(this != NULL && sueldo != NULL && !validarNumero(sueldo))//Validar que lo que recibe es un numero.
    {
